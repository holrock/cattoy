...
class ToysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post toys_url, params: { toy: { description: @toy.description, image_url: @toy.image_url, name: @toy.name, text: @toy.text, url: @toy.url } }
    end
  ...
  test "should update toy" do
    patch toy_url(@toy), params: { toy: { description: @toy.description, image_url: @toy.image_url, name: @toy.name, text: @toy.text, url: @toy.url } }
